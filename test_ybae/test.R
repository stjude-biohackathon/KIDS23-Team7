...
data1 <- fread("/home/lead/Akoya/BioHackathon_Samples/Sample1_Group1_MarkerExpression.csv")[1:10000]
data2 <- fread("/home/lead/Akoya/BioHackathon_Samples/Sample1_Group1_MetaData.csv")[1:10000]
write.csv(data1, "./test_MarkerExpression.csv")
write.csv(data2, "./test_MeataData.csv")
