...
Sample1_Group2_SeuratObj_sketch <- readRDS("/home/lead/Akoya/rds/Sample1_Group2_SeuratObj_sketch.rds")

obj = Sample1_Group2_SeuratObj_sketch
...
saveRDS(obj_celltype, file = "/home/mmarcao/Sample1_Group2_SeuratObj_sketch.rds")
