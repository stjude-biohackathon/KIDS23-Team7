...
Sample2_Group1_SeuratObj_sketch <- readRDS("/home/lead/Akoya/rds/Sample2_Group1_SeuratObj_sketch.rds")

obj = Sample2_Group1_SeuratObj_sketch
...
saveRDS(obj_celltype, file = "/home/mmarcao/Sample2_Group1_SeuratObj_sketch.rds")
